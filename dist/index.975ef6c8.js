...
var _renderMarkup = require("./js/renderMarkup");
...
async function onInputChange(e) {
    ...
    if (!searchingItem) {
        ...
        (0, _renderMarkup.cleanMarkup)();
        return;
    }
    try {
        const country = await (0, _fetchCountries.getCountryByName)(searchingItem);
        if (country.length >= 10) {
            (0, _notiflixNotifyAio.Notify).warning("Too many matches found. Please enter a more specific name.", (0, _renderMarkup.cleanMarkup)());
            return;
        } else if (country.length >= 2) (0, _renderMarkup.renderCountriesList)(country);
        else (0, _renderMarkup.renderCountry)(country);
    } catch (error) {
        (0, _notiflixNotifyAio.Notify).failure(`Oops, there is no country with that name, ${error}`, (0, _renderMarkup.cleanMarkup)());
    }
}

},{"./css/styles.css":"1CY4s","debounce":"6mekx","./js/renderMarkup":"LPz2v","./js/fetchCountries":"dKuy9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"1CY4s":[function() {},{}],"6mekx":[function(require,module,exports) {
/**
...
},{}],"LPz2v":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderCountry", ()=>renderCountry);
parcelHelpers.export(exports, "renderCountriesList", ()=>renderCountriesList);
parcelHelpers.export(exports, "cleanMarkup", ()=>cleanMarkup);
...
function renderCountry([{ name , capital , population , flags , languages  }]) {
  ...
  `;
    (0, _index.refs).countryInfo.innerHTML = markup;
}
function renderCountriesList(countries) {
    cleanMarkup();
    let markup = countries.map(({ name , flags  })=>{
    ...
    (0, _index.refs).counryList.innerHTML = markup;
}
function cleanMarkup() {
    (0, _index.refs).counryList.innerHTML = "";
    (0, _index.refs).countryInfo.innerHTML = "";
}
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCountryByName", ()=>getCountryByName);
async function getCountryByName(country) {
    console.log("fetch");
    let serverRes = await fetch(`https://restcountries.com/v3.1/name/${country}?fields=name,capital,population,flags,languages`);
